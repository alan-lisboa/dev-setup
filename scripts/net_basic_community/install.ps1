...
$client.DownloadFile('https://raw.githubusercontent.com/alan-lisboa/dev-setup/main/scripts/net_basic_community/vs2022.vsconfig', "${temp}\vs2022.vsconfig");

Set-Location $temp
.\vs_Community.exe --config "${temp}\vs2022.vsconfig"
